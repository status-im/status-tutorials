        ...
        return (
            <Provider store={store}>
                <Head>
                    ...
                    <meta property="og:description" content="Welcome to the Status Network tutorials archive" />
                    <meta name="twitter:title" content="The Status Network Tutorials" />
                    <meta name="twitter:description" content="Welcome to the Status Network tutorials archive" />
